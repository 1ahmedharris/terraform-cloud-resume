...
# A record for root domain ahmedharrisresume.com pointing to CloudFront
...
# CNAME record for subdomain www.ahmedharrisresume.com pointing to CloudFront
...
# A record for root domain ahmedharrisdevops.com pointing to CloudFront
...
# CNAME record for subdomain www.ahmedharrisdevops.com pointing to CloudFront
